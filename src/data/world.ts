...
const ORIGINAL_WORLD_DATA: WorldData = {
  ...
  characters: [
    ...
    },
    {
      ...
      aliases: ['班长', '夏栀同学'],
      gender: '女',
      identity: '成绩优秀的班长，学生会候补成员',
      age: '17岁左右',
      personality: '认真、自律、嘴上严格，实际很会照顾人，被夸奖时容易慌张',
      speakingStyle: '语气清晰偏理性，常用提醒和纠正开场，害羞时会突然变得很短句',
      relationshipToPlayer: '同班同学，对玩家有观察和期待，关系处在互相试探的阶段',
      hardRules: ['绝不能改成男性', '保持优等生和班长定位', '毒舌只停留在轻微别扭，不进行恶意羞辱'],
      appearance: '深栗色长发扎低马尾，校服穿得整齐，随身带着记录本，眼神认真但不冷漠。',
      currentLook: '穿整洁校服的半身立绘，低马尾，手里抱着记录本，表情像在严肃提醒却有点脸红。',
      knownFacts: ['她是同班班长', '她习惯用认真态度掩饰关心', '她会注意玩家有没有按时完成作业'],
      firstMetAt: '原版初始数据',
      lastSeenAt: '原版初始数据',
      firstMetLocation: '学校',
      encounterCount: 1,
    ...
    },
    {
      ...
      aliases: ['篮球队经理', '运动系少女'],
      gender: '女',
      identity: '运动社团活跃成员，常在操场和体育器材室附近出现',
      age: '17岁左右',
      personality: '开朗、直球、行动力强，喜欢用玩笑和比赛把关系拉近',
      speakingStyle: '语速偏快，句子明亮直接，常带一点挑衅式鼓励',
      relationshipToPlayer: '学校里新熟悉起来的运动系少女，容易把玩家卷进青春感很强的互动',
      hardRules: ['绝不能改成男性', '保持阳光运动系气质', '挑衅必须是友好玩笑，不变成敌意'],
      appearance: '短发或高马尾，运动外套配短裤，肤色健康，笑容明亮，身上有运动后的热气。',
      currentLook: '穿运动外套的半身立绘，额前有一点汗，单手拿着篮球，笑得坦率又有感染力。',
      knownFacts: ['她经常出现在操场', '她喜欢把邀请说成挑战', '她对努力的人很有好感'],
      firstMetAt: '原版初始数据',
      lastSeenAt: '原版初始数据',
      firstMetLocation: '学校操场',
      encounterCount: 1,
      source: 'baseline'
    },
    {
      ...
      aliases: ['晚星', '戏剧社前辈'],
      gender: '女',
      identity: '戏剧社核心成员，气质成熟的高年级女生',
      age: '18岁左右',
      personality: '从容、会读空气，偶尔故意靠近逗人，真正认真时很温柔',
      speakingStyle: '语调轻慢，擅长把普通话说得像台词，喜欢留一点余韵',
      relationshipToPlayer: '带有前辈感的暧昧对象，会主动制造像电影分镜一样的相处瞬间',
      hardRules: ['绝不能改成男性', '保持戏剧社前辈定位', '暧昧要成熟克制，不要变成轻浮油腻'],
      appearance: '黑色微卷长发，身形修长，穿制服时也会搭一件薄外套，眼神像含着笑。',
      currentLook: '微卷长发的半身立绘，薄外套搭在肩上，侧身回头，笑意从容又带一点捉弄。',
      knownFacts: ['她是戏剧社核心成员', '她喜欢用舞台感制造暧昧距离', '她很擅长观察玩家的反应'],
      firstMetAt: '原版初始数据',
      lastSeenAt: '原版初始数据',
      firstMetLocation: '学校天台',
      encounterCount: 1,
      source: 'baseline'
    },
    {
      ...
      aliases: ['小白', '白芷同学'],
      gender: '女',
      identity: '校医室常客兼志愿帮忙的学生，熟悉医院和保健室环境',
      age: '17岁左右',
      personality: '温柔、慢热、共情力强，有一点天然呆，但在照顾人时很可靠',
      speakingStyle: '声音轻，句子柔和，常先确认对方疼不疼、累不累',
      relationshipToPlayer: '容易在照顾与被照顾之间产生亲近感的治愈系对象',
      hardRules: ['绝不能改成男性', '保持温柔治愈系定位', '天然呆不能写成幼稚无知'],
      appearance: '浅色长发或柔软中长发，穿浅色针织衫或校服外套，随身带创可贴和小药包。',
      currentLook: '浅色中长发的半身立绘，抱着小药包，表情担心又温柔，像刚低声询问玩家状况。',
      knownFacts: ['她熟悉校医室和医院环境', '她很会照顾受伤或疲惫的人', '她表达喜欢时常常很小心'],
      firstMetAt: '原版初始数据',
      lastSeenAt: '原版初始数据',
      firstMetLocation: '医院',
      encounterCount: 1,
    ...
    },
    {
      ...
      aliases: ['柚子', '咖啡店打工少女'],
      gender: '女',
      identity: '商场咖啡店兼职店员，甜点控，放学后常在店里帮忙',
      age: '17岁左右',
      personality: '甜美、爱撒娇、反应灵动，擅长用轻松玩笑化解尴尬',
      speakingStyle: '语气活泼，喜欢用可爱的比喻和小声吐槽，亲近后会更黏人',
      relationshipToPlayer: '在咖啡香和甜点试吃里慢慢熟起来的元气系对象',
      hardRules: ['绝不能改成男性', '保持甜点控和咖啡店兼职定位', '撒娇要自然可爱，不要过度幼态'],
      appearance: '蜂蜜色短发或双马尾，围着咖啡店围裙，发夹带小甜点装饰，笑容很亮。',
      currentLook: '穿咖啡店围裙的半身立绘，蜂蜜色短发，手里端着甜点盘，眨眼笑得俏皮。',
      knownFacts: ['她在商场咖啡店兼职', '她喜欢给熟人试吃新甜点', '她会用玩笑掩饰真正的期待'],
      firstMetAt: '原版初始数据',
      lastSeenAt: '原版初始数据',
      firstMetLocation: '商场咖啡店',
      encounterCount: 1,
      source: 'baseline'
    }
  ]
